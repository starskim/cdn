...
if [ "${CentOS_ver}" == '7' ]; then
  curl -fsSL "https://cdn.starskim.cn/pxe/shell/hostname.sh" | /bin/sh
fi
...
######## git ########
if [ "${CentOS_ver}" == '7' ]; then
  curl -fsSL "https://cdn.starskim.cn/pxe/shell/installgit.sh" | /bin/sh
fi

######## zsh ########
if [ "${CentOS_ver}" == '7' ]; then
  curl -fsSL "https://cdn.starskim.cn/pxe/shell/ohmyzsh.sh" | /bin/sh
fi
if [ "${CentOS_ver}" == '8' ]; then
